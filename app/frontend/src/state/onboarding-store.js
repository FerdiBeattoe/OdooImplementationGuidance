...
const DEFERRED_DEFAULTS = {
  ...
  "TS-01": { defaultAnswer: "Yes", domains: ["timesheets", "projects"] },
  "TS-02": { defaultAnswer: "Yes, approval required", domains: ["timesheets", "projects"] },
  "EX-01": { defaultAnswer: "Yes", domains: ["expenses", "accounting"] },
  "EX-02": { defaultAnswer: "Direct manager", domains: ["expenses", "accounting"] },
  "AT-01": { defaultAnswer: "Manual entry", domains: ["attendance", "hr"] },
  "AT-02": { defaultAnswer: "Yes", domains: ["attendance", "hr"] },
  "RC-01": { defaultAnswer: "Yes", domains: ["recruitment", "hr"] },
  "RC-02": { defaultAnswer: "Yes", domains: ["recruitment", "hr"] },
  "FL-01": { defaultAnswer: "No", domains: ["fleet"] },
  "FL-02": { defaultAnswer: "Yes", domains: ["fleet"] },
  "EV-01": { defaultAnswer: "No", domains: ["events"] },
  "EV-02": { defaultAnswer: "Yes", domains: ["events"] },
  "EM-01": { defaultAnswer: "No", domains: ["email-marketing"] },
  "EM-02": { defaultAnswer: "Yes", domains: ["email-marketing"] },
  "HD-01": { defaultAnswer: "Yes", domains: ["helpdesk"] },
  "HD-02": { defaultAnswer: "No", domains: ["helpdesk"] },
  "PY-01": { defaultAnswer: "Yes", domains: ["payroll", "hr", "accounting"] },
  "PY-02": { defaultAnswer: "No", domains: ["payroll", "hr", "accounting"] },
  "PL-01": { defaultAnswer: "No", domains: ["planning", "hr"] },
  "PL-02": { defaultAnswer: "No", domains: ["planning", "hr"] },
  "KN-01": { defaultAnswer: "Yes", domains: ["knowledge"] },
  "DI-01": { defaultAnswer: "Yes", domains: ["discuss"] },
  "OM-01": { defaultAnswer: "Gmail / Google Workspace", domains: ["outgoing-mail"] },
  "OM-02": { defaultAnswer: "Yes", domains: ["outgoing-mail"] },
  "IM-01": { defaultAnswer: "Yes", domains: ["incoming-mail"] },
  "IM-02": { defaultAnswer: ["sales@  CRM leads", "support@  Helpdesk tickets"], domains: ["incoming-mail"] },
  "AR-01": { defaultAnswer: "No", domains: ["accounting-reports", "accounting"] },
  "SP-01": { defaultAnswer: "No", domains: ["spreadsheet"] },
  "LC-01": { defaultAnswer: "No", domains: ["live-chat"] },
  "LC-02": { defaultAnswer: "No", domains: ["live-chat"] },
  "WA-01": { defaultAnswer: "No", domains: ["whatsapp"] },
  "SM-01": { defaultAnswer: "No", domains: ["sms-marketing"] },
  "CA-01": { defaultAnswer: "Google Calendar", domains: ["calendar"] },
  "CA-02": { defaultAnswer: "No", domains: ["calendar"] },
  "AP-01": { defaultAnswer: "No", domains: ["appraisals", "hr"] },
  "AP-02": { defaultAnswer: "Annually", domains: ["appraisals", "hr"] },
  "LY-01": { defaultAnswer: "Neither", domains: ["loyalty"] },
  "RF-01": { defaultAnswer: "No", domains: ["referrals", "recruitment"] },
};
