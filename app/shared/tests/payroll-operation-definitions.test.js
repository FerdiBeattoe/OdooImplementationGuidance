...
describe("assemblePayrollOperationDefinitions", () => {
  ...
  it("3. intended_changes is null for every definition", () => { const defs = assemblePayrollOperationDefinitions(makeTargetContext(), makeDiscoveryAnswers()); for (const k of Object.keys(defs)) assert.equal(defs[k].intended_changes, null); });
