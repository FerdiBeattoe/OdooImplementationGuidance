...
4. **At least one bounded execution flow per deployment type** — All 12 wizard surfaces now have governed write paths; end-to-end validation against real Odoo instances is required
