    ...
    el("section", { className: "mkt-section" }, [
      el("div", { className: "mkt-shell mkt-stack" }, [
        ...
        el("div", { className: "mkt-qna" }, [
          ...
          renderFaqItem("Does Project Odoo work with existing Odoo instances?", "Version 1 is optimised for fresh Odoo 19 databases. If you have an existing instance with partial configuration, Project Odoo will still guide your implementation — however, full detection and skipping of pre-configured settings is coming in V2. We recommend starting with a clean Odoo 19 database for the best experience."),
