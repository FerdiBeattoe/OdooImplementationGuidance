  ...
  if (payload && typeof payload === "object" && !Array.isArray(payload) && !payload.operation_definitions) {
    ...
    payload = {
      ...
      operation_definitions: {
        ...
        ...assembleUsersRolesOperationDefinitions(tc, da, wizardCaptures),
        ...assembleAccountingOperationDefinitions(tc, da, wizardCaptures),
        ...assembleMasterDataOperationDefinitions(tc, da, wizardCaptures),
        ...assembleCrmOperationDefinitions(tc, da, wizardCaptures),
        ...assembleSalesOperationDefinitions(tc, da, wizardCaptures),
        ...assemblePurchaseOperationDefinitions(tc, da, wizardCaptures),
        ...assembleInventoryOperationDefinitions(tc, da, wizardCaptures),
        ...assembleManufacturingOperationDefinitions(tc, da, wizardCaptures),
        ...assemblePlmOperationDefinitions(tc, da, wizardCaptures),
        ...assemblePosOperationDefinitions(tc, da, wizardCaptures),
        ...assembleWebsiteEcommerceOperationDefinitions(tc, da, wizardCaptures),
        ...assembleProjectsOperationDefinitions(tc, da, wizardCaptures),
        ...assembleHrOperationDefinitions(tc, da, wizardCaptures),
        ...assembleQualityOperationDefinitions(tc, da, wizardCaptures),
        ...assembleMaintenanceOperationDefinitions(tc, da),
        ...assembleRepairsOperationDefinitions(tc, da),
        ...assembleDocumentsOperationDefinitions(tc, da, wizardCaptures),
        ...assembleSignOperationDefinitions(tc, da, wizardCaptures),
        ...assembleApprovalsOperationDefinitions(tc, da, wizardCaptures),
        ...assembleSubscriptionsOperationDefinitions(tc, da, wizardCaptures),
        ...assembleRentalOperationDefinitions(tc, da),
        ...assembleFieldServiceOperationDefinitions(tc, da, wizardCaptures),
...
function buildOperationDefinitionsFromRuntimeState(runtimeState) {
  ...
  return {
    ...assembleFoundationOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleUsersRolesOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleAccountingOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleMasterDataOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleCrmOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleSalesOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...
    ...assembleManufacturingOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assemblePlmOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assemblePosOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleWebsiteEcommerceOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleProjectsOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleHrOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleQualityOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...
    ...assembleDocumentsOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleSignOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleApprovalsOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleSubscriptionsOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
    ...assembleRentalOperationDefinitions(targetContext, discoveryAnswers),
    ...assembleFieldServiceOperationDefinitions(targetContext, discoveryAnswers, wizardCaptures),
